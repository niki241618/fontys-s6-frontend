...
import css from './css/Privacy.module.css';
            ...
            <Row>
                <Col>
                    <div className={css.wrapper}>
                        <p>At Audio Oasis, accessible from <a href="https://audiooasis.com">https://audiooasis.com</a>,
                            one of our main priorities is the privacy of our visitors. This Privacy Policy document
                            contains types of information that is collected and recorded by Audio Oasis and how we use
                            it.</p>
                        ...
                        <p>Audio Oasis legal basis for collecting and using the personal information described in this
                            Privacy Policy depends on the Personal Information we collect and the specific context in
                            which we collect the information:</p>

                        <ul>
                            <li>Audio Oasis needs to perform a contract with you</li>
                            <li>You have given Audio Oasis permission to do so</li>
                            <li>Processing your personal information is in Audio Oasis legitimate interests</li>
                            <li>Audio Oasis needs to comply with the law</li>
                        </ul>

                        <p>Audio Oasis will retain your personal information only for as long as is necessary for the
                        ...
                        <h2>Log Files</h2>
                        <p>Audio Oasis follows a standard procedure of using log files. These files log visitors when
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            Beacons that are used in their respective advertisements and links that appear on Audio
                            Oasis, which are sent directly to users' browser. They automatically receive your IP address
                        ...
                        <p>Note that Audio Oasis has no access to or control over these cookies that are used by
                            third-party advertisers.</p>

                        <h2>Third Party Privacy Policies</h2>
                        <p>Audio Oasis's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                        ...
                        <p>Audio Oasis does not knowingly collect any Personal Identifiable Information from children
                        ...
                        <p>Our Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in Audio Oasis. This
